...
class DataUserSerializerTest(serializers.ModelSerializer):
    """Сериалайзер для модели Data_Users c определеннными полями"""
